					...
					?>
              		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" name="comment_form">
						<?php 
							...
							{ 
                                ...
                                <div class="four columns">
                                    <div class="tr_wrapper" style="z-index:0;margin-top:5px;margin-left:13px;">
                                ...
                                <div class="four columns">
                                    <div class="tr_wrapper" style="z-index:0;margin-top:5px;margin-left:11px;">
                                        <div class="submenu_ct_man pirenko_tinted">
                                ...
                                <div class="four columns">
                                    <div class="tr_wrapper" style="z-index:0;margin-top:5px;margin-left:15px;">
                                        <div class="submenu_ct_man pirenko_tinted">
                        ...
                        <div id="submit_comment_div" class='theme_button_inverted'>
                        	<a href="#"><?php _e($pixia_frontend_options['comments_submit'], 'pixia'); ?></a>
                      	</div>
                        <div class="clearfix"></div>
