				...
				while (have_posts()) : the_post(); 
					...
					<div id="blog_entries_masonr">
						...
						while ($my_query->have_posts()) : $my_query->the_post(); 
							$post_counter++;
							?>
							<div id="post-<?php the_ID(); ?>" class="colored_bg boxed_shadow blog_entry_li cf" data-type="<?php $category= get_the_category();
							...
							{ 
									...
									if (has_post_thumbnail( $post->ID ) )
									{
										...
										<a href="<?php the_permalink() ?>">
											...
											<?php 
												...
												{
													?>
													<img src="<?php echo get_template_directory_uri() ?>/inc/modules/timthumb/timthumb.php?src=<?php echo $image[0]; ?>&w=385&f=2" class="custom-img grid_image <?php if ($pixia_frontend_options['blog_bw']=="yes") echo " desaturated_image"; ?>" alt="" />
													<?php
												}
											?>
										</a>
								...
								<div class="entry_title entry_title_single mini_padded_text mini_unpadded_low" style="max-width:385px">
                                	<div class="f_liner masonr_date">
                                            <span class="masonr_date"><?php echo the_time(get_option('date_format')); ?></span>
                                        </div>
								...
								<div class="on_colored mini_padded_text entry_content" style="max-width:385px">
									<span class="masonr_text"><?php echo the_excerpt_dynamic(80); ?></span>
                                    </div>
                                        ...
                                        if ($pixia_frontend_options['categoriesby_news']=="yes")
                                        {
                                            ...
                                            <div class="f_liner">
                                                ...
                                                <span class="masonr_inactive" style="margin-left:21px;">
                                                	<?php the_category(', '); //CATS WITH LINKS ?></span>
                                                </div>
                                        ...
                                        <div class="right_floated">
                                            <div class="f_liner">
                                                    ...
                                                    <div class="masonr_read_more">
                                                    	<div class="right_floated">
                                                        <a href="<?php the_permalink() ?>" style="margin-top: -2px;margin-bottom: 8px;"><?php _e($pixia_frontend_options['read_more'], 'pixia'); ?></a>
                                                    	</div>
                                                 	</div>
                                            </div>
                                            <?php
												if ( comments_open($post->ID) ) :
													?>
														...
														<div class="f_liner" style="margin-right:23px;margin-bottom:0px;">
																<?php 
																	comments_number( '0', '1 ', '%');
																?>
														</div>
