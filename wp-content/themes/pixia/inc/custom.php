<?php
	...
	$css .= "body,
			...
			#bottom_sidebar_in .pk_contact_highlighted {
				background-color: $inactive_color;
				background-color:rgba($splitted_inactive_color[0], $splitted_inactive_color[1], $splitted_inactive_color[2], 0.35);
			} 
			...
			.pixia_theme .rectangle-bounce div, .member_colored_block_in {background-color: $body_color;}
			.ui-tooltip-tipsy .ui-tooltip-titlebar, 
			.ui-tooltip-tipsy .ui-tooltip-content,
			...
			.ui-tabs .ui-tabs-panel.prk_tab {
				border-right: 1px solid rgba($splitted_inactive_color[0], $splitted_inactive_color[1], $splitted_inactive_color[2],0.25) !important;
				border-left: 1px solid rgba($splitted_inactive_color[0], $splitted_inactive_color[1], $splitted_inactive_color[2],0.25) !important;
				border-bottom: 1px solid rgba($splitted_inactive_color[0], $splitted_inactive_color[1], $splitted_inactive_color[2],0.25) !important;
			}
			#nav-main.resp_mode,
			.boxed_shadow
			{
				-webkit-box-shadow:0px 1px 2px rgba($splitted_shadow_color[0], $splitted_shadow_color[1], $splitted_shadow_color[2],".$custom_shadow.");
				box-shadow:0px 1px 2px rgba($splitted_shadow_color[0], $splitted_shadow_color[1], $splitted_shadow_color[2],".$custom_shadow.");
			}
			#bottom_sidebar,
			.bottom_teaser {
...
#next_portfolio_masonry,
  ...
  if (PRK_WOO==true) {
	$css .=".woocommerce-page #main .pirenko_highlighted,.woocommerce #main .pirenko_highlighted,.woocommerce ul.cart_list li del,.woocommerce ul.product_list_widget li del,.woocommerce div.product p.price del,.woocommerce ul.products li.product .price del, .woocommerce-page ul.products li.product .price del {
            color: $inactive_color;
        }";
        $css.="	.woocommerce #main #respond input#submit.alt,
        ...
        $css.=".woocommerce .order_details li {border-right-color:$inactive_color;border-right-color:rgba($splitted_inactive_color[0], $splitted_inactive_color[1], $splitted_inactive_color[2],0.25)}";
        $css.=".woocommerce table.shop_table td,.woocommerce-cart .cart-collaterals .cart_totals tr td, .woocommerce-cart .cart-collaterals .cart_totals tr th,.woocommerce table.shop_table tbody th, .woocommerce table.shop_table tfoot td, .woocommerce table.shop_table tfoot th {border-top: 1px solid $inactive_color;border-top: 1px solid rgba($splitted_inactive_color[0], $splitted_inactive_color[1], $splitted_inactive_color[2],0.25);}";
        $css.=".woocommerce div.product p.price, .woocommerce div.product span.price {color:$active_color;}";
        $css.=".woocommerce ul.products li.product .price,.woocommerce .zero_color {color:$darker_inactive_color;}";
		$css.=".woocommerce-checkout #wrap .woocommerce h3 {border-bottom: 1px solid $inactive_color;border-bottom: 1px solid rgba($splitted_inactive_color[0], $splitted_inactive_color[1], $splitted_inactive_color[2],0.25);}";
		$css.=".pixia_woo_thumb a.pixia_woo_add_button{background-color:$darker_inactive_color;color:$background_color;}";
		$css.=".pixia_woo_thumb a.pixia_woo_add_button:hover{color:$active_color;}";
		$css.="#wrap .woocommerce table th, .woocommerce-page #wrap table th,tr.order_item .product-name,.order_details.bacs_details {color:$darker_inactive_color;}";
}
