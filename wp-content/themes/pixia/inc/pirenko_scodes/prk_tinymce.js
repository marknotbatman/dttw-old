            ...
            ed.addButton('prk_tinymce_btn', {
                ...
                onclick : function() 
				{
                     var open_shortcodes = jQuery("#prk_shortcodes_sub").length;
						...
						{
							jQuery("#content_prk_tinymce_btn,#prk_tinymce_btn").append("<div id='prk_shortcodes_sub' role='listbox' class='mceMenu mceSplitButtonMenu wp_themeSkin mceNoIcons'><table><tbody><tr><td id='prk_tm_accordion' class='mceMenuItem mceMenuItemEnabled'><a href='#'>Accordion</a></td></tr><tr><td id='prk_tm_blockquote' class='mceMenuItem mceMenuItemEnabled'><a href='#'>Blockquote</a></td></tr><td id='prk_tm_button' class='mceMenuItem mceMenuItemEnabled'><a href='#'>Button</a></td></tr><tr><td id='prk_tm_lists' class='mceMenuItem mceMenuItemEnabled'><a href='#'>List</a></td></tr><tr><td id='prk_tm_layout' class='mceMenuItem mceMenuItemEnabled'><a href='#'>Layout</a></td></tr><tr><td id='prk_tm_boxes' class='mceMenuItem mceMenuItemEnabled'><a href='#'>Message</a></td></tr><tr><td id='prk_tm_tabs' class='mceMenuItem mceMenuItemEnabled'><a href='#'>Tabs</a></td></tr><tr><td id='prk_tm_members' class='mceMenuItem mceMenuItemEnabled'><a href='#'>Team Members</a></td></tr></tbody></table></div>");
                            ...
                            jQuery("#prk_tm_members").click(function(){
                                tb_show("Shortcodes - Insert Team Members Feed", url + "/s_window.php?popup=members");                            
                            });
						}
