<?php
                                        ...
                                        <select name="pixia_theme_options[header_font]">
                                            <?php    
                                                if (!is_array($options['header_font']))
												{
											        ...
											        update_option('aria_theme_options', $options);
												}
                                ...
                                ?>
                               	<tr valign="top">
                                    <th scope="row">
                                        ...
                                        <p><em>To get your custom code visit <a href="http://maps.google.com/" target="_blank">http://maps.google.com/</a> and select your location. Click on the hyperlink button and copy/paste the code here.<br />If you need an API Key please check this article <a href="https://developers.google.com/maps/documentation/embed/guide" target="_blank">https://developers.google.com/maps/documentation/embed/guide</a></em></p>
                                     </th>
                                     <td>
                                     <input id="pixia_theme_options[google-maps]" size="90%" type="pirenko-text" name="pixia_theme_options[google-maps]" value="<?php echo esc_textarea( $options['google-maps'] ); ?>" />
                                     </td>
                                 </tr>
                                  <?php
                                    //HELP TEXT ON NAME
                        ...
                        <div class="pixia_tab_options">
                            <table class="form-table">
                                ...
                                <tr valign="top"><th scope="row"><h3><?php _e( 'VARIOUS', 'pixiatheme' ); ?></h3></th>
                                    ...
                                    if (!isset($options['no_more_text']))
                                        $options['no_more_text']="No more posts to show";
                                    ?>
                                    <tr valign="top">
                                        <th scope="row">
                                            <?php _e( 'No more posts to show', 'pixiatheme' ); ?>
                                        </th>
                                        <td width="275">
                                            <input id="pixia_theme_options[no_more_text]" size="45" maxlength="50" type="text" name="pixia_theme_options[no_more_text]" value="<?php echo( $options['no_more_text'] ); ?>" />
                                        </td>
                                    </tr>
                                    <?php
                                    //LAUNCH PROJECT TEXT
	...
	"skip_featured" => array(
	"name" => "skip_featured",
	"title" => "Use featured image on slideshow and Lightbox?",
	"description" => ""),
	"no_slider" => array(
	"name" => "no_slider",
