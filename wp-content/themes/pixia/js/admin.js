...
jQuery(document).ready(function() {
	...
	jQuery('#pirenko_verify_form.themed').on('submit', function (e) {
	    ...
	    jQuery.ajax({
	        type : "get",  
	        url: 'https://www.pirenko.com/licenses/wp-json/check_license/prk_core?prk_key='+pirenko_purchase_key+'&prk_domain='+pirenko_path+'&prk_theme_id='+jQuery('#pirenko_verify_form').attr('data-theme'),
