...
<div id="content" class="<?php echo CONTAINER_CLASSES; ?> top_40">
				...
				<div class="inner_line_sidebar_block"></div>
                    <?php
                        if ($pixia_frontend_options['contact-address']!="")
                        {
                            ...
                            <div class="contact_address_block cf">
                                <div class="tr_wrapper">
                                    <i class="pixia_fa-home zero_color_cl"></i>
                                </div>
                        ...
                        if ($pixia_frontend_options['contact-info_tel']!="")
                        {
                            ...
                            <div class="contact_address_block cf">
                                <div class="tr_wrapper">
                                    <i class="pixia_fa-phone zero_color_cl"></i>
                                </div>
                        ...
                        if ($pixia_frontend_options['contact-info_fax']!="")
                        {
                            ...
                            <div class="contact_address_block cf">
                                <div class="tr_wrapper">
                                    <i class="pixia_fa-fax zero_color_cl"></i>
                                </div>
                                <h5 class="contact_address_right_single">
                        ...
                        if ($pixia_frontend_options['contact-info_email']!="")
                        {
                            ...
                            <div class="contact_address_block cf">
                                <div class="tr_wrapper">
                                    <i class="pixia_fa-envelope zero_color_cl"></i>
                                </div>
                                <h5 class="contact_address_right_single">
                ...
                <h4>
                    ...
                    <div class="row">
                    	<div class="four columns">
                            <div class="tr_wrapper" style="z-index:0;margin-top:0px;margin-left:13px;">
                        ...
                        <div class="four columns">
                            <div class="tr_wrapper" style="z-index:0;margin-top:0px;margin-left:11px;">
                                <div class="submenu_ct_man pirenko_tinted">
                        ...
                        <div class="four columns">
                            <div class="tr_wrapper" style="z-index:0;margin-top:1px;margin-left:16px;">
                                <div class="submenu_ct_man pirenko_tinted">
                                    <i class="clearer_inactive_color pixia_fa-info"></i>
                                </div>
                            </div>
                        ...
                        <div id="submit_message_div" class="theme_button">
                            <a href="#"><?php _e($pixia_frontend_options['contact_submit'], 'pixia'); ?></a>
                        </div>
	...
	jQuery(document).ready(function()
	{
		...
		var empty_text_error = '<?php echo esc_attr(__($pixia_frontend_options['contact_error_text'], 'pixia')); ?>';
		var invalid_email_error = '<?php echo esc_attr(__($pixia_frontend_options['contact_error_email_text'], 'pixia')); ?>';
		var contact_ok='<p><?php echo esc_attr(__($pixia_frontend_options['contact_ok_text'], 'pixia')); ?></p>';
