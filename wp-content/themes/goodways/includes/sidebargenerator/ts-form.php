<?php
function ts_form_admin($optionstheme, $theslug) {
	ts_saveform_admin($optionstheme, $theslug);
	
	$themename = TS_THEMENAME;
...
?>
	...
	a.delimguploader{
		background-image:url(<?php echo get_template_directory_uri();  ?>/admin/images/ico-delete.png);
	...
	a.delbutton{
		display:block;
		background-image:url(<?php echo get_template_directory_uri();  ?>/admin/images/delbutton.gif);
		background-repeat:no-repeat;
	...
	jQuery(document).ready(function(){
			...
			jQuery("input#buttonarray<?php echo $value['id']; ?>").click(function(evt){
				...
				if(textarrayid!=""){
					...
					alert('<?php _e('Please input the textbox first!','templatesquare'); ?>');
				}
			});
			...
			function delbuttononclick(evt){
				...
				<?php 
					$url = (!empty($_SERVER['HTTPS'])) ? "https://".$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'] : "http://".$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']; 
				?>
				if(confirm('<?php _e('Are you sure you want to delete this item?','templatesquare'); ?>')){
	...
	<div class="bordertitle"></div>
		...
		<tr valign="top"> 
		    ...
		    <td class="rowfield">
                ...
                <input name="buttonarray<?php echo $value['id']; ?>" id="buttonarray<?php echo $value['id']; ?>" type="button" class="button-primary" value="<?php _e("Add", "templatesquare"); ?>" /><br />
    ...
    <input name="reset" type="submit" class="button-secondary"  value="<?php _e('Restore Defaults', 'templatesquare')?>" onclick="return confirm('<?php _e('Click OK to reset. Any theme settings will be lost!', 'templatesquare')?>');"/>
...
function ts_saveform_admin($optionstheme, $theslug){
