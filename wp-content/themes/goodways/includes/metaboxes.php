...
$meta_boxes[] = array(
	...
	'title' => __('Page Sidebar Option','templatesquare'),
	'page' => 'page',
	...
	'fields' => array(
		array(
			'name' => __('Registered Sidebar','templatesquare'),
			'desc' => '<em>'.__('Please choose the sidebar for this page','templatesquare').'</em>',
			'options' => $optsidebar,
			'id' => $prefix.'sidebar',
			'type' => 'select',
			'std' => ''
...
$meta_boxes[] = array(
	...
	'title' => __('Post Sidebar Option','templatesquare'),
	'page' => 'post',
	...
	'fields' => array(
		array(
			'name' => __('Registered Sidebar','templatesquare'),
			'desc' => '<em>'.__('Please choose the sidebar for this post','templatesquare').'</em>',
			'options' => $optsidebar,
			'id' => $prefix.'sidebar',
			'type' => 'select',
			'std' => 'post-sidebar'
...
//If Select Combobox			
			case 'select-slider-category':
				...
				'taxonomy'           => 'slidercat',
				'name'             =>$field['id'],
				'show_option_all'	=> __('All Categories','templatesquare')
				);
