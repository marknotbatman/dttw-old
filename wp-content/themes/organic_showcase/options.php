...
function optionsframework_options() {
	...
	$options[] = array( "name" => __("Portfolios", 'organicthemes'),
		...
		$options[] = array( "name" => __("Display Home Portfolio?", 'organicthemes'),
							"desc" => __("Select whether or not you would like to display the portfolio beneath the featured slideshow on the homepage.", 'organicthemes'),
							"id" => "display_portfolio_home",
							"std" => "1",
							"type" => "checkbox");
		
		$options[] = array( "name" => __("Choose Portfolio Page Columns", 'organicthemes'),
							"id" => "portfolio_columns",
							"std" => "three",
							"type" => "radio",
							"options" => $columns_array);
							
		$options[] = array( "name" => __("Portfolio Template Posts To Display", 'organicthemes'),
							"desc" => __("Enter the number of posts you would like to display on the home portfolion and portfolio page template.", 'organicthemes'),
							"id" => "postnumber_portfolio",
							"std" => "12",
							"type" => "text");
							
		$options[] = array( "name" => __("Display Portfolio Page Info?", 'organicthemes'),
							"desc" => __("Select whether or not you would like to display the post title and excerpt for portfolio posts on the homepage and portfolio page template.", 'organicthemes'),
		...
		$options[] = array( "name" => __("Display Portfolio Category Info?", 'organicthemes'),
	...
	$options[] = array( "name" => __("Layout", 'organicthemes'),
		...
		$options[] = array( "name" => __("Center Site?", 'organicthemes'),
							"desc" => __("This option centers the site in the browser, instead of aligning to the left.", 'organicthemes'),
							"id" => "center_site",
							"std" => "0",
							"type" => "checkbox");
							
		$options[] = array( "name" => __("Enable CSS3 Full Width Background Image?", 'organicthemes'),
							"desc" => __("This option enables an applied background image to stretch to the full width of the browser. Do not use with tiled backgrounds", 'organicthemes'),
	...
	$options[] = array( "name" => __("Social", 'organicthemes'),
		...
		$options[] = array( "name" => __("Page Social Buttons?", 'organicthemes'),
							"desc" => __("Displays the Facebook Like, Tweet, Pinterest and Google Plus buttons on pages.", 'organicthemes'),
							"id" => "display_social_page",
							"std" => "1",
							"type" => "checkbox");
							
		$options[] = array( "name" => __("ost Social Buttons?", 'organicthemes'),
							"desc" => __("Displays the Facebook Like, Tweet, Pinterest and Google Plus buttons on posts.", 'organicthemes'),
