...
class JSON_API {
  ...
  function admin_options() {
    if (!current_user_can('manage_options'))  {
      wp_die( __('You do not have sufficient permissions to access this page.', 'json-api') );
    }
...
<div class="wrap">
  ...
  <form action="options-general.php?page=json-api" method="post">
          ...
          <tr class="<?php echo ($active ? 'active' : 'inactive'); ?>">
            ...
            <td class="plugin-title">
              ...
              <div class="row-actions-visible">
                ...
                if ($active) {
                  echo '<a href="' . wp_nonce_url('options-general.php?page=json-api&amp;action=deactivate&amp;controller=' . $controller, 'update-options') . '" title="' . __('Deactivate this controller', 'json-api') . '" class="edit">' . __('Deactivate', 'json-api') . '</a>';
                } else if (!$error) {
                  echo '<a href="' . wp_nonce_url('options-general.php?page=json-api&amp;action=activate&amp;controller=' . $controller, 'update-options') . '" title="' . __('Activate this controller', 'json-api') . '" class="edit">' . __('Activate', 'json-api') . '</a>';
                }
    ...
    <h3>Address</h3>
    <p>Specify a base URL for JSON API. For example, using <code>api</code> as your API base URL would enable the following <code><?php echo home_url(); ?>/api/get_recent_posts/</code>. If you assign a blank value the API will only be available by setting a <code>json</code> query variable.</p>
    <table class="form-table">
      <tr valign="top">
        <th scope="row">API base</th>
        <td><code><?php echo home_url(); ?>/</code><input type="text" name="json_api_base" value="<?php echo get_option('json_api_base', 'api'); ?>" size="15" /></td>
      </tr>
    </table>
    ...
    <?php } ?>
    <p class="submit">
      <input type="submit" class="button-primary" value="<?php _e('Save Changes', 'json-api') ?>" />
    </p>
  </form>
</div>
<?php
