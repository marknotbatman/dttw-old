...
?>
<!DOCTYPE html>
<html <?php language_attributes(); ?> class="nav-left nav-closed header3">
<head>
...
<div class="mobile-menu-bar"><i class="ti-menu menu-bars-icon"></i><?php echo $search_location; ?><?php echo $mobile_email; ?><?php echo $mobile_phone; ?><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src='<?php echo esc_url($skyline_data['logo_img']['url']); ?>' alt='logo image' /></a></div>
