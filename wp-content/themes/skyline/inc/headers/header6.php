...
?>
<!DOCTYPE html>
<html <?php language_attributes(); ?> class="nav-top <?php echo $nav_transparent; ?> header6">
<head>
...
<div class="col-md-6">
<div class="tag-line">
<?php echo wp_kses($skyline_data['header_text'], array(
    'a' => array(
        'href' => array()
    ),
	'i' => array(
...
<div class="col-md-6 text-right nav-social-icons">
